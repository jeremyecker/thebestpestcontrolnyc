...
const AREAS: Area[] = [
  ...
  { slug: "sunnyside", name: "Sunnyside", borough: "Queens", region: "Queens, NYC", propertyType: "attached rowhouses and walkup apartments", nearbyAreas: ["woodside", "astoria", "long-island-city", "maspeth", "ridgewood"], characteristics: "working-class residential, historic garden apartments, older building stock" },
