...
const FAQ_CATEGORIES: { id: string; label: string; icon: string; count: number; items: FAQItem[] }[] = [
  {
    ...
    items: [
      ...
      { q: "What areas do you serve?", a: "We serve 310+ neighborhoods across Manhattan, Brooklyn, Queens, the Bronx, Staten Island, northern New Jersey, Long Island, and Westchester County. If you're anywhere in the NYC metro area, we have a technician near you." },
  ...
  },
  {
    ...
    items: [
      ...
      { q: "How much does cockroach extermination cost?", a: "Cockroach extermination in NYC typically runs $350–$550 for a standard apartment treatment. Larger properties, severe infestations, or multi-unit building treatments cost more. We always provide a free inspection and exact written quote before work begins." },
    ],
  },
  {
    id: "bed-bugs",
    ...
    items: [
      ...
      { q: "What does bed bug treatment cost?", a: "Bed bug treatment in NYC typically runs $1,200–$3,500 depending on room count, infestation severity, and treatment method. We provide a free inspection and written quote before any work begins. No money upfront." },
    ],
  },
  {
    id: "rodents",
    ...
    items: [
      ...
      { q: "How much does rodent control cost?", a: "Rat or mouse extermination in NYC typically runs $350–$600 for standard treatment. Rodent proofing costs $500–$3,000 depending on property size and number of entry points. We always provide a free inspection and written quote before work begins." },
    ],
  },
  {
    id: "wildlife",
