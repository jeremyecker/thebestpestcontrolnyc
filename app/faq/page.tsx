...
const FAQ_CATEGORIES: { id: string; label: string; icon: string; count: number; items: FAQItem[] }[] = [
  {
    ...
    items: [
      ...
      { q: "How do I pay?", a: "You pay when the job is done and you're satisfied. We accept all major credit cards, debit cards, and checks." },
    ],
  },
  {
    id: "cockroaches",
  ...
  return (
    <>
      ...
      <section className="bg-green-800 text-white py-16 px-4 text-center">
        ...
        <p className="text-green-100 text-xl mb-8 max-w-xl mx-auto">Free phone quote. Licensed and insured across NY, NJ, and PA.</p>
        <div className="flex flex-wrap justify-center gap-4">
