...
export const metadata: Metadata = {
  ...
  description: "Licensed pest control in The Bronx. 36 neighborhoods served — Riverdale, Fordham, Mott Haven, Pelham Bay, and more. Free phone quote. Same-day available.",
  ...
  "@graph": [
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: "The Bronx", item: "https://www.thebestpestcontrolnyc.com/areas/the-bronx" },
      ],
    },
  ],
};

export default function TheBronxPage() {
  const areas = AREAS.filter((a) => a.borough === "Bronx").sort((a, b) => a.name.localeCompare(b.name));
  ...
  return (
    <>
      ...
      <nav className="bg-gray-100 px-4 py-2 text-sm text-gray-600">
        ...
        <span className="text-gray-900 font-medium">The Bronx</span>
      </nav>
      ...
      <section className="bg-green-800 text-white py-16 px-4">
        <div className="max-w-5xl mx-auto">
          <h1 className="text-5xl font-bold mb-4" style={{ fontFamily: "'Barlow Condensed', sans-serif" }}>
            Pest Control in The Bronx
          </h1>
          <p className="text-xl text-green-100 mb-8 max-w-3xl">
            Licensed and insured exterminators across NY, NJ, and PA serving all {areas.length} The Bronx neighborhoods. Cockroaches, bed bugs, rats, termites, wildlife, and 32 pest types. Free phone quote.
          </p>
      ...
      <section className="max-w-5xl mx-auto px-4 pt-10 pb-12">
        ...
        <div className="mt-12 bg-green-800 text-white rounded-2xl p-8 text-center">
          <h2 className="text-2xl font-bold mb-3">Need Pest Control in The Bronx?</h2>
          <p className="text-green-100 mb-6">Licensed exterminators. Free phone quote. Same-day available across all The Bronx neighborhoods.</p>
        ...
        <div className="mt-12 bg-gray-50 rounded-2xl p-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-6" style={{ fontFamily: "'Barlow Condensed', sans-serif" }}>
            Why The Bronx Customers Choose Us
          </h2>
          <ul className="space-y-3 text-gray-700">
            <li className="flex items-start gap-3"><span className="text-green-700 font-bold text-xl">✓</span> Licensed and insured exterminators across NY, NJ, and PA with The Bronx experience</li>
      ...
      <section className="bg-green-800 text-white py-16 px-4 text-center">
        ...
        <p className="text-green-100 text-xl mb-8 max-w-xl mx-auto">Free phone quote. Same-day available in The Bronx.</p>
        <div className="flex flex-wrap justify-center gap-4">
