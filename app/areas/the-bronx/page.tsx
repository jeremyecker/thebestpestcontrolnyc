      ...
      <section className="bg-green-800 text-white py-16 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-xl text-green-100 mb-8 max-w-3xl">
            Licensed NYS DEC exterminators serving all {areas.length} The Bronx neighborhoods. Cockroaches, bed bugs, rats, termites, wildlife, and 32 pest types. Free inspection. No money upfront.
          </p>
