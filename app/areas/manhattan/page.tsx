...
export const metadata: Metadata = {
  ...
  description: "Licensed pest control in Manhattan. 36 neighborhoods served — Upper East Side, Midtown, Greenwich Village, SoHo, and more. Free phone quote. Same-day available.",
  ...
  "@graph": [
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: "Manhattan", item: "https://www.thebestpestcontrolnyc.com/areas/manhattan" },
      ],
    },
  ],
};
...
export default function ManhattanPage() {
  const areas = AREAS.filter((a) => a.borough === "Manhattan").sort((a, b) => a.name.localeCompare(b.name));
  ...
  return (
    <>
      ...
      <nav className="bg-gray-100 px-4 py-2 text-sm text-gray-600">
        ...
        <span className="text-gray-900 font-medium">Manhattan</span>
      </nav>
      ...
      <section className="bg-green-800 text-white py-16 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-xl text-green-100 mb-8 max-w-3xl">
            Licensed and insured exterminators across NY, NJ, and PA serving all {areas.length} Manhattan neighborhoods. Cockroaches, bed bugs, rats, termites, wildlife, and 32 pest types. Free phone quote.
          </p>
      ...
      <section className="max-w-5xl mx-auto px-4 pt-10 pb-12">
        ...
        <div className="mt-12 bg-green-800 text-white rounded-2xl p-8 text-center">
          <h2 className="text-2xl font-bold mb-3">Need Pest Control in Manhattan?</h2>
          <p className="text-green-100 mb-6">Licensed exterminators. Free phone quote. Same-day available across all Manhattan neighborhoods.</p>
        ...
        <div className="mt-12 bg-gray-50 rounded-2xl p-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-6" style={{ fontFamily: "'Barlow Condensed', sans-serif" }}>
            Why Manhattan Customers Choose Us
          </h2>
          <ul className="space-y-3 text-gray-700">
            <li className="flex items-start gap-3"><span className="text-green-700 font-bold text-xl">✓</span> Licensed and insured exterminators across NY, NJ, and PA with Manhattan experience</li>
      ...
      <section className="bg-green-800 text-white py-16 px-4 text-center">
        ...
        <p className="text-green-100 text-xl mb-8 max-w-xl mx-auto">Free phone quote. Same-day available in Manhattan.</p>
        <div className="flex flex-wrap justify-center gap-4">
