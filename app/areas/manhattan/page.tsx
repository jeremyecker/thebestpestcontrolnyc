    ...
    <>
      ...
      <section className="bg-green-800 text-white py-16 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-xl text-green-100 mb-8 max-w-3xl">
            Licensed NYS DEC exterminators serving all {areas.length} Manhattan neighborhoods. Cockroaches, bed bugs, rats, termites, wildlife, and 32 pest types. Free inspection. No money upfront.
          </p>
      ...
      <section className="max-w-5xl mx-auto px-4 pt-10 pb-12">
        ...
        <div className="mt-12 bg-green-800 text-white rounded-2xl p-8 text-center">
          ...
          <p className="text-green-100 mb-6">Licensed exterminators. Free inspection. No money upfront. Same-day available across all Manhattan neighborhoods.</p>
      ...
      <section className="bg-green-800 text-white py-16 px-4 text-center">
        ...
        <p className="text-green-100 text-xl mb-8 max-w-xl mx-auto">Free inspection. No money upfront. Guaranteed results. Same-day available in Manhattan.</p>
        <div className="flex flex-wrap justify-center gap-4">
