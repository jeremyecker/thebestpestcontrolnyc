...
export const metadata: Metadata = {
  title: { absolute: "Pest Control in Northern New Jersey | The Best Pest Control NYC" },
  description: "Licensed pest control in Northern New Jersey. 48 neighborhoods served — Jersey City, Hoboken, Newark, Montclair, and more. Free phone quote. Same-day available.",
  alternates: { canonical: "https://www.thebestpestcontrolnyc.com/areas/new-jersey" },
  openGraph: {
    title: "Pest Control in Northern New Jersey | The Best Pest Control NYC",
    description: "Licensed pest control in Northern New Jersey. 48 neighborhoods served — Jersey City, Hoboken, Newark, Montclair, and more. Free phone quote. Same-day available.",
    url: "https://www.thebestpestcontrolnyc.com/areas/new-jersey",
  ...
  "@graph": [
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: "Northern New Jersey", item: "https://www.thebestpestcontrolnyc.com/areas/new-jersey" },
      ],
    },
  ],
};

export default function NorthernNewJerseyPage() {
  const areas = AREAS.filter((a) => a.borough === "New Jersey").sort((a, b) => a.name.localeCompare(b.name));
  ...
  return (
    <>
      ...
      <nav className="bg-gray-100 px-4 py-2 text-sm text-gray-600">
        ...
        <span className="text-gray-900 font-medium">Northern New Jersey</span>
      </nav>
      ...
      <section className="bg-green-800 text-white py-16 px-4">
        <div className="max-w-5xl mx-auto">
          <h1 className="text-5xl font-bold mb-4" style={{ fontFamily: "'Barlow Condensed', sans-serif" }}>
            Pest Control in Northern New Jersey
          </h1>
          <p className="text-xl text-green-100 mb-8 max-w-3xl">
            Licensed and insured exterminators across NY, NJ, and PA serving all {areas.length} Northern New Jersey neighborhoods. Cockroaches, bed bugs, rats, termites, wildlife, and 32 pest types. Free phone quote.
          </p>
      ...
      <section className="max-w-5xl mx-auto px-4 pt-10 pb-12">
        ...
        <div className="mt-12 bg-green-800 text-white rounded-2xl p-8 text-center">
          <h2 className="text-2xl font-bold mb-3">Need Pest Control in Northern New Jersey?</h2>
          <p className="text-green-100 mb-6">Licensed exterminators. Free phone quote. Same-day available across all Northern New Jersey neighborhoods.</p>
        ...
        <div className="mt-12 bg-gray-50 rounded-2xl p-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-6" style={{ fontFamily: "'Barlow Condensed', sans-serif" }}>
            Why Northern New Jersey Customers Choose Us
          </h2>
          <ul className="space-y-3 text-gray-700">
            <li className="flex items-start gap-3"><span className="text-green-700 font-bold text-xl">✓</span> Licensed and insured exterminators across NY, NJ, and PA with Northern New Jersey experience</li>
      ...
      <section className="bg-green-800 text-white py-16 px-4 text-center">
        ...
        <p className="text-green-100 text-xl mb-8 max-w-xl mx-auto">Free phone quote. Same-day available in Northern New Jersey.</p>
        <div className="flex flex-wrap justify-center gap-4">
