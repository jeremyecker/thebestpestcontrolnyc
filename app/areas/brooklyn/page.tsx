  ...
  "@graph": [
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: "Brooklyn", item: "https://www.thebestpestcontrolnyc.com/areas/brooklyn" },
      ],
    },
  ],
};
...
export default function BrooklynPage() {
  const areas = AREAS.filter((a) => a.borough === "Brooklyn").sort((a, b) => a.name.localeCompare(b.name));
  ...
  return (
    <>
      ...
      <nav className="bg-gray-100 px-4 py-2 text-sm text-gray-600">
        ...
        <span className="text-gray-900 font-medium">Brooklyn</span>
      </nav>
