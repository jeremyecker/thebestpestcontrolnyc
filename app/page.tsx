      ...
      <section className="bg-green-800 text-white pt-16 pb-20 px-4">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-10">
            ...
            <a href={`sms:${PHONE}`} className="bg-green-600 text-white font-bold px-8 py-4 rounded-xl text-lg hover:bg-green-500 transition border border-green-400 shadow-lg">
      ...
      <section className="py-16 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { num: "1", title: "Contact Us", desc: "Text us, call us, or book online. Send a photo if you have one. We respond in minutes. A quick two-question conversation gets you on the schedule." },
      ...
      <section className="bg-green-800 text-white py-20 px-4 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a href={`sms:${PHONE}`} className="bg-green-600 text-white font-bold px-8 py-4 rounded-xl text-lg hover:bg-green-500 transition border border-green-400">💬 Text Us Now</a>
